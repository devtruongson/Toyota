...
import { getAllRegisterFormByMe } from '../../services/registerFormService';
...
export default function Me() {
    ...
    const _fetch = async () => {
        try {
            const res = await getAllRegisterFormByMe(filter);
        ...
        },
        {
            ...
            render: (item: IRegisterForm) => (
                <select
                    ...
                    className="bg-gray-50 disabled border mb-5 border-gray-300 w-[400px] text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5"
                >
